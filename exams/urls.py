...
urlpatterns = [
    ...
    path('<int:pk>/update-scores/', views.exam_update_scores, name='update_scores'),
    path('<int:pk>/remove-question/<int:qpk>/', views.exam_remove_question, name='remove_question'),
    path('question/<int:pk>/preview/', views.question_preview, name='question_preview'),
    ...
    path('session/<int:pk>/begin/', views.exam_begin_timer, name='begin_timer'),
